...
public interface StatsDAO {
	...
	void insertReceiverMaxAlt(long date, String receiverName, String aircraftId, String aircraftReg, float aircraftAlt);

	void updateReceiverMaxAlt(long date, String receiverName, String aircraftId, String aircraftReg, float aircraftAlt);

	float getReceiverMaxAlt(long date, String receiverName);
